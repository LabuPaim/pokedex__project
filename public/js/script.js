...
poke.addEventListener('mouseover', () => {    
    ...
    pokeLINE1.styleCadastro.backgroundColor ='#fff';
    pokeLINE2.styleCadastro.backgroundColor ='#fff';
})

poke.addEventListener('mouseleave', () => {    
    pokeLINE1.style.backgroundColor ='rgb(85, 84, 84)';
    pokeLINE2.style.backgroundColor ='rgb(85, 84, 84)';
    pokeLINE1.styleCadastro.backgroundColor ='rgb(85, 84, 84)';
    pokeLINE2.styleCadastro.backgroundColor ='rgb(85, 84, 84)';
})
